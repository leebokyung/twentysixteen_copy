...
class sir_latest_board_widget extends SIR_COMM_Widget {
	...
	public function __construct() {
        ...
        */
		...
		$this->widget_description = __( '그누커머스 최신글 위젯입니다.', 'gnucommerce-2016-summer-ipha' );
		$this->widget_id          = 'sir_comm_latest';
		$this->widget_name        = __( '그누커머스 최신글 위젯', 'gnucommerce-2016-summer-ipha' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( '최신글', 'gnucommerce-2016-summer-ipha' ),
			...
			'rows' => array(
				...
				'max'   => 20,
				'std'   => 5,
				'label' => __( '출력할 갯수', 'gnucommerce-2016-summer-ipha' ),
			),
			'bo_table' => array(
				'type'  => 'select',
				'std'   => '',
				'label' => __( '출력할 게시판', 'gnucommerce-2016-summer-ipha' ),
				'options' => $board_array,
			),
			'skin_dir' => array(
				'type'  => 'select',
				'std'   => '',
				'label' => __( '스킨폴더', 'gnucommerce-2016-summer-ipha' ),
			...
			'row_mod' => array(
				...
				'max'   => 6,
				'std'   => 3,
				'label' => __( '이미지 스킨일 경우 한줄에 출력할 갯수 설정', 'gnucommerce-2016-summer-ipha' ),
			),
            'url'   => array(
                'type'  => 'text',
				'std'   => '',
                'label' => __( '주소( url )를 지정합니다.', 'gnucommerce-2016-summer-ipha' ),
            ),
			'subject_len' => array(
				'type'  => 'number',
				'step'  => 1,
				...
				'max'   => 40,
				'std'   => 40,
				'label' => __( '출력할 제목 길이', 'gnucommerce-2016-summer-ipha' ),
			),
			'content_len' => array(
				'type'  => 'number',
				'step'  => 1,
				...
				'max'   => 80,
				'std'   => 80,
				'label' => __( '출력할 내용 길이', 'gnucommerce-2016-summer-ipha' ),
			),
			'cache_time' => array(
				'type'  => 'number',
				'step'  => 1,
				...
				'max'   => '',
				'std'   => 1,
				'label' => __( '캐쉬사용( 미사용시 0으로 설정 )', 'gnucommerce-2016-summer-ipha' ),
			),
		);
