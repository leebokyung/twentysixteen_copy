...
<div id="scash" class="new_win">
    <h1 id="win_title"><?php echo GC_VAR()->print_title(); ?></h1>
    <section>
        <h2>주문정보</h2>
    ...
    <section>
        ...
        <form method="post" id="LGD_PAYINFO" action="<?php echo gc_get_page_url('taxsave_result'); ?>">
        <input type="hidden" name="tx"        value="<?php echo esc_attr($tx); ?>">
        <input type="hidden" name="od_id" value="<?php echo esc_attr($od_id); ?>">
        <input type="hidden" name="pg_service"    value="lg">
        <div class="tbl_head01 tbl_wrap">
            <table>
            <colgroup>
                <col class="grid_3">
