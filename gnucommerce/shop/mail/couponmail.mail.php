...
<head>
<meta charset="utf-8">
<title><?php echo get_bloginfo(); ?> - 쿠폰발행알림 메일</title>
</head>
...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        <h1 style="margin:0 0 20px;padding:30px 30px 20px;background:#f7f7f7;color:#555;font-size:1.4em">
            <?php echo get_bloginfo();?> - 쿠폰발행알림 메일
        </h1>
        ...
        <a href="<?php echo get_site_url(); ?>" target="_blank" style="<?php echo $ft_a_st; ?>"><?php echo get_bloginfo(); ?> 바로가기</a>
