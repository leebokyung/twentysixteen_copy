...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        ...
        <p style="<?php echo $cont_st; ?>">이 주문과 관련된 내용은 <b><?php echo $config['de_admin_company_tel']; ?></b>로 연락주시기 바랍니다.</p>

        <a href="<?php echo home_url(); ?>" target="_blank" style="<?php echo $ft_a_st; ?>"><?php echo get_bloginfo(); ?></a>
