...
<head>
<meta charset="utf-8">
<title><?php echo get_bloginfo(); ?> - 주문 알림 메일</title>
</head>
...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        <h1 style="margin:0 0 20px;padding:30px 30px 20px;background:#f7f7f7;color:#555;font-size:1.4em">
            <?php echo get_bloginfo();?> - 주문이 접수되었습니다.
        </h1>

        <p style="<?php echo $cont_st; ?>">
            <strong>주문번호 <?php echo $od_id; ?></strong><br>
            본 메일은 <?php echo GC_TIME_YMDHIS; ?> (<?php echo gc_get_yoil(GC_TIME_YMDHIS); ?>)을 기준으로 작성되었습니다.
        </p>
        ...
        <tr>
            ...
            <td style="<?php echo $td_st; ?>"><a href="<?php echo get_permalink($list[$i]['it_id']); ?>" target="_blank" style="text-decoration:none"><span style="display:inline-block;vertical-align:middle"><?php echo $list[$i]['it_simg']; ?></span> <?php echo $list[$i]['it_name']; ?></a></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">판매가격</th>
            <td style="<?php echo $td_st; ?>"><?php echo gc_display_price($list[$i]['ct_price']); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="<?php echo $td_st; ?>"><?php echo gc_display_price($list[$i]['stotal_price']); ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">적립금</th>
            <td style="<?php echo $td_st; ?>"><?php echo gc_display_mileage($list[$i]['stotal_point']); ?></td>
        </tr>
        <?php } ?>
        ...
        <tr>
            ...
            <td style="<?php echo $td_st; ?>"><?php echo gc_display_price($od_send_cost); ?></td>
        </tr>
        <?php } ?>
        ...
        <tr>
            ...
            <td style="<?php echo $td_st; ?>"><?php echo gc_display_price($od_send_cost2); ?></td>
        </tr>
        <?php } ?>

        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">주문합계</th>
            <td style="<?php echo $td_st; ?>"><?php echo gc_display_price($ttotal_price); ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">적립금합계</th>
            <td style="<?php echo $td_st; ?>"><?php echo gc_display_mileage($ttotal_point); ?></td>
        </tr>
        </tbody>
        </table>
        ...
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">적립금 입금액</th>
            <td style="<?php echo $td_st; ?>"><?php echo gc_display_mileage($od_receipt_point); ?></td>
        </tr>
        <?php } ?>

        <?php if ($od_receipt_price > 0 && $od_settle_case == gc_get_stype_names('creditcard')) { //신용카드?>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">신용카드 입금액</th>
            <td style="<?php echo $td_st; ?>"><?php echo gc_display_price($od_receipt_price); ?></td>
        </tr>
        <?php } ?>

        <?php if ($od_receipt_price > 0 && $od_settle_case == gc_get_stype_names('accounttransfer')) {  //계좌이체 ?>
        <tr>
        ...
        <tr>
            ...
            <td style="<?php echo $td_st; ?>"><?php echo sprintf("(%s)", $od_zip).' '.gc_print_address($od_addr1, $od_addr2, $od_addr3, $od_addr_jibeon); ?></td>
        </tr>

        <?php if ($od_hope_date) { ?>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">희망배송일</th>
            <td style="<?php echo $td_st; ?>"><?php echo $od_hope_date;?> (<?php echo gc_get_yoil($od_hope_date);?>)</td>
        </tr>
        <?php } ?>
        </tbody>
        </table>
        ...
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">주소</th>
            <td style="<?php echo $td_st; ?>"><?php echo sprintf("(%s)", $od_b_zip).' '.gc_print_address($od_b_addr1, $od_b_addr2, $od_b_addr3, $od_b_addr_jibeon); ?></td>
        </tr>
        <tr>
        ...
        <p style="<?php echo $cont_st; ?>">배송지를 변경하실 고객님은 <b><?php echo $config['de_admin_company_tel']; ?></b>로 연락주시기 바랍니다.</p>

        <a href="<?php echo gc_get_page_url('orderinquiry'); ?>" target="_blank" style="<?php echo $ft_a_st; ?>">주문상세내역 확인</a>
