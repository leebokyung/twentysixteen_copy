...
<head>
<meta charset="utf-8">
<title><?php echo get_bloginfo();?> - 주문내역 처리 안내</title>
</head>
...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        <h1 style="margin:0 0 20px;padding:30px 30px 20px;background:#f7f7f7;color:#555;font-size:1.4em">
            <?php echo get_bloginfo();?> - 주문내역 처리 안내
        </h1>
        ...
        <tr>
            <td style="<?php echo $td_st; ?>"><a href="<?php echo get_permalink($cart_list[$h]['it_id']); ?>" target="_blank" style="text-decoration:none"><?php echo $cart_list[$h]['it_name']; ?></a></td>
        ...
        <table style="<?php echo $cont_st; ?>">
        <caption style="<?php echo $caption_st; ?>">적립금 결제 확인</caption>
        <colgroup>
            <col style="width:130px">
            <col>
        </colgroup>
        ...
        <a href="<?php echo get_site_url(); ?>" target="_blank" style="<?php echo $ft_a_st; ?>"><?php echo get_bloginfo(); ?></a>
    </div>
</div>
