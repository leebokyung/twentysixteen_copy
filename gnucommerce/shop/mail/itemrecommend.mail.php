...
<head>
<meta charset="utf-8">
<title><?php echo get_bloginfo(); ?> - <?php echo $from_name; ?> 의 상품 추천 메일</title>
</head>
...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        ...
        <div style="margin:0 0 10px;text-align:center">
            <a href="<?php echo get_permalink($it_id); ?>" target="_blank" style="display:inline-block;margin:0 0 10px"><?php echo $it_mimg; ?></a><br>
            <?php echo $it_name; ?>
        </div>
        ...
        <a href="<?php echo get_permalink($it_id); ?>" target="_blank" style="<?php echo $ft_a_st; ?>">상품 자세히 보기</a>
