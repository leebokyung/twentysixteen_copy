...
require_once(GC_LGXPAY_PATH.'/lgdacom/XPayClient.php');
...
$LGD_TIMESTAMP          = date('YmdHis', GC_SERVER_TIME);                                   //타임스탬프
...
//$LGD_RETURNURL          = G5_SHOP_URL.'/lg/returnurl.php';
$LGD_RETURNURL          = add_query_arg( array('lgpay'=>'returnurl'), gc_get_page_url('cart'));                  //LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
...
$configPath             = GC_LGXPAY_PATH.'/lgdacom';                               //LG유플러스에서 제공한 환경파일("/conf/lgdacom.conf") 위치 지정.

/*
 * 가상계좌(무통장) 결제 연동을 하시는 경우 아래 LGD_CASNOTEURL 을 설정하여 주시기 바랍니다.
 */
//$LGD_CASNOTEURL     = G5_SHOP_URL.'/settle_lg_common.php';
$LGD_CASNOTEURL     = add_query_arg( array('virtualacc'=>'lg'), gc_get_page_url('cart'));
?>