...
$sendName   = gc_iconv_euckr($od['od_name']);
$sendPost   = $od['od_zip1'].$od['od_zip2'];
$sendAddr1  = gc_iconv_euckr($od['od_addr1']);
$sendAddr2  = gc_iconv_euckr($od['od_addr2']);
$sendTel    = $od['od_tel'];
$recvName   = gc_iconv_euckr($od['od_b_name']);
$recvPost   = $od['od_b_zip1'].$od['od_b_zip2'];
$recvAddr   = gc_iconv_euckr($od['od_b_addr1'].($od['od_b_addr2'] ? ' ' : '').$od['od_b_addr2']);
$recvTel    = $od['od_b_tel'];
