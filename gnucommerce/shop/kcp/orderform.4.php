...
<section id="sod_frm_escrow">
    ...
    <table>
    <tr>
        <td><img src="<?php echo GC_SHOP_URL; ?>/img/marks_escrow/escrow_foot.gif" width="290" height="92" border="0" usemap="#Map"></td>
    </tr>
    <tr>
        <td>
...
<!-- <?php if ($config['de_card_use'] || $config['de_iche_use']) { echo "결제대행사 : KCP"; } ?> -->