...
if( GC_IS_MOBILE ){  //모바일이면
    include( __DIR__ ."/m_orderform.2.php");
    return;
}
    /* ============================================================================== */
    /* =   2. 가맹점 필수 정보 설정                                                 = */
...
?>
    ...
    <input type="hidden" name="site_cd"         value="<?php echo $config['de_kcp_mid']; ?>">
    <input type="hidden" name="site_name"       value="<?php echo $config['de_admin_company_name']; ?>">
    <input type="hidden" name="def_site_cd"     value="<?php echo $config['de_kcp_mid']; ?>">
