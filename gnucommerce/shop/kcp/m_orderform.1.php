...
// 결제등록 요청시 사용할 입금마감일
$ipgm_date = date("Ymd", (GC_SERVER_TIME + 86400 * 5));
$param_opt_1 = isset($param_opt_1) ? $param_opt_1 : '';
$param_opt_2 = isset($param_opt_2) ? $param_opt_2 : '';
$param_opt_3 = isset($param_opt_3) ? $param_opt_3 : '';
...
<input type="hidden" name="kcppay" value="return">
