...
<div id="sit_ov_wrap">
    ...
    <ul class="clearfix">
        ...
        <li id="sit_ov" class="w50">
            <h2 id="sit_title"><?php echo stripslashes($post->post_title); ?> <span class="sound_only"><?php _e('요약정보 및 구매', GC_NAME); ?></span></h2>
            ...
            <div id="sit_ov_btn">
                ...
                <button type="button" data-itid="<?php echo $it['it_id']; ?>" title="<?php _e('상품 재입고알림 SMS', GC_NAME); ?>" id="sit_btn_buy"><?php _e('재입고알림', GC_NAME); ?></button>
                <?php } ?>
                <button type="button" onclick="gc_item_wish(document.fitem, '<?php echo $it['it_id']; ?>');" id="sit_btn_wish"><?php _e('위시리스트', GC_NAME); ?></button>
            </div>
